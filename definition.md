...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Then, jump into (@) and do it again. Do this until we reach (Z 0/a #), at which point stop.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Then we have (x' y 0/b <span>$</span>'), for some x' and <span>$</span>'. Xₐ = (x' y 0 Xₐ₋₁ 1/b-1 <span>$</span>').  
4. When we have [z 0(0#)? a @]n, then change it to \[z 0 **(0#)?** 1(0#)? a-1 @\]n and jump into the bolded separator.
